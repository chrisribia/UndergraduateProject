...
import com.example.project.ui.addCreditors.NewCreditorViewModelFactory
import com.example.project.ui.addDebtor.NewDebtorViewModelFactory
...
class MVVMApplication : Application(), KodeinAware {
    ...
    override val kodein = Kodein.lazy {
        ...
        bind() from provider { NewCreditorViewModelFactory(instance()) }
